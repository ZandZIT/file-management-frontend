...
import {  Download, MoreVertical, PencilLine, Share, Star, Trash } from 'lucide-react'
import { Fragment, useState, } from 'react'
import PropTypes from 'prop-types'
import UpdateFolderModal from '../modal/update-folder-modal'
...
export default function ContentActions({folder}) {
  const [renameModal, setRenameModal] = useState(false)
  const [alertModal, setAlertModal] = useState(false)

  const links = [
    { action: () => setRenameModal(true), label: 'Rename', icon: PencilLine },
    { action: (data) => handleStar(data), label: 'Star', icon: Star },
